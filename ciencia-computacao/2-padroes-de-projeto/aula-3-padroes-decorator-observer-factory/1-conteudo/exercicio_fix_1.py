...
class CalculadoraDecoradaIngles:
    ...
    def converterNumeroIngles(self, numero):
        if not isinstance(numero, str):
            return numero
    ...
    def soma(self, x, y):
        return self.calculadora.soma(
            self.converterNumeroIngles(x), self.converterNumeroIngles(y)
        )
...
if __name__ == "__main__":
    ...
    print("'eight' + 'two' =", calculadoraDecoradaIngles.soma("eight", "two"))
