// 1- Utilizando o array abaixo, percorra-o somando todos os valores. Caso o valor final seja maior que 15, imprima-o. Caso seja igual ou menor que 15, imprima a mensagem: "valor menor que 16":
...
for (let index = 0; index < fruits.length; index += 1) {
    soma += fruits[index]; //é a mesma coisa que "soma = soma + fruits[index];""
  }
